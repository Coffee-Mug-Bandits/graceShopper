          ...
          <div class="flex justify-start flex-col items-start space-y-2">
            <button class="flex flex-row items-center text-gray-600 dark:text-white hover:text-gray-500 space-x-1">
              <p
                ...
                class="text-sm text-black leading-none"
              >
                Back
              </p>
            </button>
            <p class="text-3xl lg:text-4xl font-semibold leading-7 lg:leading-9 text-gray-800 dark:text-black-50">
              Checkout
            </p>
            <p class="text-base leading-normal sm:leading-4 text-gray-600 dark:text-white"></p>
          </div>

          <div class="flex flex-col xl:flex-row justify-center  space-y-6 xl:space-y-0 xl:space-x-6 w-full">
            <div class="p-8 bg-gradient-to-t from-yellow-900 to-yellow-600 flex flex-col lg:w-full xl:w-3/5">
              <button class="border border-transparent hover:border-gray-300 bg-gray-900 dark:bg-white dark:hover:bg-gray-900 dark:hover:bg-yellow-200 dark:text-gray-900  hover:bg-white text-white hover:text-gray-900 flex flex-row justify-center items-center space-x-2 py-4 rounded w-full">
                <div>
                  <svg
                    class="fill-current"
                    width="16"
              ...
              <div className=" flex justify-center text-white mt-12 text-2xl">
