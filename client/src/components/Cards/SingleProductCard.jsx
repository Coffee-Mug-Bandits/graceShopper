export default function SingleProductCard({ selectedProduct }) {
  ...
  <div className="flex items-center flex-col justify-center mt-44">
    ...
    <img
      ...
      />
      <h3 className="text-2xl absolute right-28 mb-36">Price: {selectedProduct.price}</h3>
      <button className="text-2xl absolute right-28 mt-20 bg-yellow-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"> Add to Cart </button>
      <button className="text-2xl absolute right-28 mb-12 bg-yellow-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"> Back to Shop</button>
    </div>
